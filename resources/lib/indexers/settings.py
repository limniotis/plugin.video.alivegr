    ...
    def info(self):
        ...
        self.list = [
            ...
            },
            {
                ...
                'action': 'dmca',
                'plot': disclaimer,
                'icon': kodi.addonmedia(addonid=ART_ID, theme='icons', path='dmca.png')
            },
            {
            ...
            },
            {
                ...
                'icon': kodi.addonmedia(addonid=ART_ID, theme='icons', path='github.png')
            },
            {
                ...
                'url': TWITTER,
                'plot': 'X Profile',
                'icon': kodi.addonmedia(addonid=ART_ID, theme='icons', path='x.png')
            },
            {
            ...
            {
                'title': kodi.i18n(30303).format(separator, platform.python_version()),
                'action': 'system_info',
                'plot': kodi.i18n(30263),
